...
const { putTransaction, getTransactions, getPortfolios, getPortfolio, getPortfolioDocumentSources, putPortfolio, deletePortfolio, deleteTransaction, updateTransaction, createAnalysisJob, getAnalysisJob, updateAnalysisJob, createDocImportJob, getDocImportJob, updateDocImportJob } = require("./utils/ddb");
