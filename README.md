...
*   **Notifications:** An email alert will automatically be dispatched to `placeholder@example.com` if actual OR forecasted monthly costs exceed **80% ($8.00 USD)** of the limit.
